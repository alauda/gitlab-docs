...
For a full set of features available in GitLab v18.5 Community Edition, please refer to the [GitLab v18.5 Documentation](https://archives.docs.gitlab.com/18.5/).
